...
From Figure \ref{fig:pam-silhouette} we can observe that most of the clusters has very high value of silhouette and only few of them has some negative values. The results look very interesting and now check how the clusters look inside.
